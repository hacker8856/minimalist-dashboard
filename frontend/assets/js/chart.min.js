...
class DatasetController {
  ...
  linkScales() {
    const t = this.chart,
      ...
      o = (e.rAxisID = valueOrDefault(i.rAxisID, getFirstScaleId(t, "r"))),
      r = e.indexAxis,
  ...
  buildOrUpdateElements(t) {
    ...
    ((e._stacked = isStacked(e.vScale, e)),
      e.stack !== i.stack && ((s = !0), clearStacks(e), (e.stack = i.stack)),
      this._resyncElements(t),
      (s || a !== e._stacked) && updateStacks(this, e._parsed));
  }
  configure() {
  ...
  updateRangeFromParsed(t, e, i, s) {
    ...
    (s && o && ((s.values = o), (n = applyStack(s, a, this._cachedMeta.index))),
  ...
  _resolveElementOptions(t, e = "default", i) {
    ...
    return (
      g.$shared &&
        ((g.$shared = r), (a[n] = Object.freeze(cloneIfNotShared(g, r)))),
      g
    );
  }
...
function parseFloatBar(t, e, i, s) {
  ...
  (Math.abs(o) > Math.abs(r) && ((l = r), (h = o)),
    (e[i.axis] = h),
    (e._custom = { barStart: l, barEnd: h, start: a, end: n, min: o, max: r }));
}
function parseValue(t, e, i, s) {
  return (
    isArray(t) ? parseFloatBar(t, e, i, s) : (e[i.axis] = i.parse(t, s)),
    e
  );
}
...
class BarController extends DatasetController {
    ...
    for (let u = e; u < e + i; u++) {
      const e = this.getParsed(u),
        ...
        f = {
          ...
          base: i.base,
          enableBorderRadius:
            !p || isFloatBar(e._custom) || n === p._top || n === p._bottom,
          x: l ? i.head : g.center,
          y: l ? g.center : i.head,
  ...
  _calculateBarValuePixels(t) {
    ...
    if (
      ((c = this.chart.getDataVisibility(t) ? e.getPixelForValue(g + p) : m),
      (d = c - m),
      Math.abs(d) < n)
    ) {
  ...
  _calculateBarIndexPixels(t, e) {
    ...
    if (e.grouped) {
      const i = a ? this._getStackCount(t) : e.stackCount,
        l =
          "flex" === s.barThickness
            ? computeFlexCategoryTraits(t, e, s, i)
            : computeFitCategoryTraits(t, e, s, i),
        h = this._getStackIndex(
          this.index,
          this._cachedMeta.stack,
          a ? t : void 0,
        );
      ((o = l.start + l.chunk * h + l.chunk / 2),
        (r = Math.min(n, l.chunk * l.ratio)));
    } else
  ...
  updateElements(t, e, i, s) {
    ...
    for (let d = e; d < e + i; d++) {
      const e = t[d],
        ...
        u = {},
        g = (u[h] = a ? n.getPixelForDecimal(0.5) : n.getPixelForValue(i[h])),
...
class DoughnutController extends DatasetController {
  ...
  updateElements(t, e, i, s) {
    ...
    for (f = e; f < e + i; ++f) {
      ...
      (p &&
        (n.options =
          g || this.resolveDataElementOptions(f, i.active ? "active" : s)),
        (m += e),
    ...
    for (let i = 0; i < b; ++i) {
      ...
      const y = this.getParsed(i),
        ...
        S = (b[u] =
          a || v
            ? o.getBasePixel()
            : o.getPixelForValue(r ? this.applyStack(o, y, r) : y[u], i));
      ((b.skip = isNaN(k) || isNaN(S) || v),
        (b.stop = i > 0 && Math.abs(y[d] - _[d]) > f),
        p && ((b.parsed = y), (b.raw = l.data[i])),
        c &&
          (b.options =
            h || this.resolveDataElementOptions(i, g.active ? "active" : s)),
    ...
    for (d = e; d < e + i; d++) {
      ...
      let i = u,
        ...
        f = n.getDataVisibility(d)
          ...
          : 0;
      ((u = p),
        a && (o.animateScale && (f = 0), o.animateRotate && (i = p = c)));
      const m = {
        x: l,
        y: h,
        innerRadius: 0,
    ...
    for (let h = e; h < e + i; ++h) {
      const e = t[h],
        ...
        v = (p[g] =
          a || _
            ? o.getBasePixel()
            : o.getPixelForValue(r ? this.applyStack(o, i, r) : i[g], h));
...
function fitBoxes(t, e, i, s) {
  ...
  for (n = 0, o = t.length, h = 0; n < o; ++n) {
    ((r = t[n]),
      (l = r.box),
      l.update(r.width || e.w, r.height || e.h, getMargins(r.horizontal, e)));
  ...
  for (const r of t) {
    ...
    if (r.horizontal) {
      ...
      (defined(l.start) && (o = l.start),
        t.fullSize
          ? setBoxDims(t, a.left, o, i.outerWidth - a.right - a.left, n)
      ...
      (defined(l.start) && (n = l.start),
        t.fullSize
          ? setBoxDims(t, n, a.top, o, i.outerHeight - a.bottom - a.top)
...
function skip(t, e, i, s, a) {
  ...
  let r,
    ...
    c = 0;
  for (
    i = Math.ceil(i), a && ((r = a - s), (i = r / Math.floor(r / i))), h = n;
    h < 0;
...
function titleAlign(t, e, i) {
  ...
  return (
    ((i && "right" !== e) || (!i && "right" === e)) && (s = reverseAlign(s)),
    s
  );
}
...
class Scale extends Element {
  ...
  getMinMax(t) {
    let e,
      { min: i, max: s, minDefined: a, maxDefined: n } = this.getUserBounds();
  ...
  calculateLabelRotation() {
    ...
    ((n = t.offset ? this.maxWidth / i : u / (i - 1)),
      c + 6 > n &&
        ...
        (l = toDegrees(
          Math.min(
            Math.asin(_limitValue((h.highest.height + 6) / n, -1, 1)),
  ...
  fit() {
    ...
    if (n) {
      ...
      if (
        (o
          ? ((t.width = this.maxWidth), (t.height = getTickMarkLength(a) + n))
          : ((t.height = this.maxHeight), (t.width = getTickMarkLength(a) + n)),
        ...
        if (isArray(d))
          for (h = 0, c = d.length; h < c; ++h)
            ((b = d[h]),
              isNullOrUndef(b) ||
                isArray(b) ||
                ((m = _measureText(s, p.data, p.gc, m, b)), (x += f)));
            ...
            (w =
              "top" === s
                ? "near" === l || 0 !== p
                  ? -P * M + M / 2
                  : "center" === l
                    ? -A.highest.height / 2 - e * M + M
                    : -A.highest.height + M / 2
                : "near" === l || 0 !== p
                  ? M / 2
                  : "center" === l
                    ? A.highest.height / 2 - e * M
                    : A.highest.height - P * M),
            c && (w *= -1),
            0 === p || t.showLabelBackdrop || (y += (M / 2) * Math.sin(p)))
          : ((v = S), (w = ((1 - P) * M) / 2)),
        t.showLabelBackdrop)
      ) {
...
function pluginOpts(t, { plugin: e, local: i }, s, a) {
  ...
  return (
    ...
    t.createResolver(o, a, [""], { scriptable: !1, indexable: !1, allKeys: !0 })
  );
}
...
function retrieveAxisFromDatasets(t, e) {
  if (e.data && e.data.datasets) {
    ...
    if (i.length)
      return (
        getAxisFromDataset(t, "x", i[0]) || getAxisFromDataset(t, "y", i[0])
      );
  }
  return {};
}
...
class Config {
  ...
  resolveNamedOptions(t, e, i, s = [""]) {
    const a = { $shared: !0 },
      { resolver: n, subPrefixes: o } = getResolver(this._resolverCache, t, s);
    let r = n;
    if (needContext(n, e)) {
...
const hasFunction = (t) =>
  isObject(t) &&
  Object.getOwnPropertyNames(t).reduce((e, i) => e || isFunction(t[i]), !1);
...
class Chart {
  ...
  constructor(t, e) {
    ...
    ((this.id = uid()),
      ...
      (this.$context = void 0),
      (this._doResize = debounce((t) => this.update(t), n.resizeDelay || 0)),
      (this._dataChanges = []),
    ...
    for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
      ...
      if (
        ...
        const e = registry.getController(n),
          { datasetElementType: s, dataElementType: o } = defaults.datasets[n];
        (Object.assign(e, {
  ...
  _updateDatasets(t) {
    if (
      ...
      for (let e = 0, i = this.data.datasets.length; e < i; ++e)
        this._updateDataset(e, isFunction(t) ? t({ datasetIndex: e }) : t);
  ...
  _drawDataset(t) {
    const e = this.ctx,
      i = t._clip,
      s = !i.disabled,
      a = getDatasetArea(t, this.chartArea),
...
class ArcElement extends Element {
  ...
  inRange(t, e, i) {
    const s = this.getProps(["x", "y"], i),
      ...
      u = valueOrDefault(c, r - o) >= TAU || _angleBetween(a, o, r),
      g = _isBetween(n, l + d, h + d);
    return u && g;
  }
  getCenterPoint(t) {
    const {
...
function lttbDecimation(t, e, i, s, a) {
  ...
  for (o[l++] = t[f], c = 0; c < n - 2; c++) {
    ...
    const b = Math.floor(c * r) + 1 + e,
      ...
      { x: y, y: v } = t[f];
    for (u = g = -1, s = b; s < _; s++)
      ((g = 0.5 * Math.abs((y - a) * (t[s].y - v) - (y - t[s].x) * (n - v))),
        g > u && ((u = g), (d = t[s]), (p = s)));
    ((o[l++] = d), (f = p));
  }
  return ((o[l++] = t[h]), o);
...
function getStartAndCountOfVisiblePointsSimplified(t, e) {
  ...
  return (
    ...
    (s = h ? _limitValue(_lookupByKey(e, n.axis, r).hi + 1, a, i) - a : i - a),
    { start: a, count: s }
  );
}
var plugin_decimation = {
  ...
  beforeElementsUpdate: (t, e, i) => {
    ...
    t.data.datasets.forEach((e, a) => {
      ...
      let { start: c, count: d } = getStartAndCountOfVisiblePointsSimplified(
        r,
        l,
      );
  ...
  return (
    e.segments.forEach(({ start: t, end: e }) => {
      ...
      null !== s
        ...
        : null !== i && (n.push({ x: i, y: o.y }), n.push({ x: i, y: r.y }));
    }),
    n
  );
}
...
function doFill(t, e) {
  const { line: i, target: s, above: a, below: n, area: o, scale: r } = e,
    l = i._loop ? "angle" : e.axis;
  (t.save(),
    "x" === l &&
      n !== a &&
      (clipVertical(t, s, o.top),
      fill(t, { line: i, target: s, color: a, scale: r, property: l }),
      t.restore(),
      t.save(),
      clipVertical(t, s, o.bottom)),
    fill(t, { line: i, target: s, color: n, scale: r, property: l }),
    t.restore());
}
...
function fill(t, e) {
  const { line: i, target: s, property: a, color: n, scale: o } = e,
    r = _segments(i, s, a);
  for (const { source: e, target: l, start: h, end: c } of r) {
    const { style: { backgroundColor: r = n } = {} } = e,
      d = !0 !== s;
    (t.save(),
      (t.fillStyle = r),
      clipBounds(t, o, d && _getBounds(a, h, c)),
      t.beginPath());
...
function clipBounds(t, e, i) {
  const { top: s, bottom: a } = e.chart.chartArea,
    { property: n, start: o, end: r } = i || {};
...
var index = {
  ...
  afterDatasetsUpdate(t, e, i) {
    ...
    for (o = 0; o < s; ++o)
      ((l = a[o]),
        l && !1 !== l.fill && (l.fill = _resolveTarget(a, o, i.propagate)));
  },
  beforeDraw(t, e, i) {
...
class Legend extends Element {
  ...
  adjustHitBoxes() {
    ...
    if (this.isHorizontal()) {
      let a = 0,
        o = _alignStartEnd(i, this.left + s, this.right - this.lineWidths[a]);
      for (const r of e)
        (a !== r.row &&
          ((a = r.row),
          (o = _alignStartEnd(
      ...
      (r.setWidth(this.width),
        m
          ? y > 0 &&
            ...
            u.line++,
            (D = u.x =
              _alignStartEnd(a, this.left + h, this.right - i[u.line])))
          : y > 0 &&
            M + b > this.bottom &&
      ...
      if (
        ((function (t, e, i) {
          ...
          if (
            ...
            (s.lineDashOffset = valueOrDefault(i.lineDashOffset, 0)),
            ...
            (s.beginPath(),
              Object.values(l).some((t) => 0 !== t)
                ? addRoundedRectPath(s, { x: o, y: n, w: g, h: p, radius: l })
                : s.rect(o, n, g, p),
              s.fill(),
              0 !== a && s.stroke());
          }
...
function calculateItemHeight(t, e, i) {
  let s = t;
  return (
    "string" != typeof e.text && (s = calculateLegendItemHeight(e, i)),
    s
  );
}
...
class Title extends Element {
  ...
  _drawArgs(t) {
    ...
    return (
      this.isHorizontal()
        ...
        : ("left" === n.position
            ? ((l = i + t), (h = _alignStartEnd(o, s, e)), (c = -0.5 * PI))
            : ((l = a - t), (h = _alignStartEnd(o, e, s)), (c = 0.5 * PI)),
          (r = s - e)),
  ...
  draw() {
    ...
    const i = toFont(e.font),
      ...
      { titleX: a, titleY: n, maxWidth: o, rotation: r } = this._drawArgs(s);
...
function getTooltipSize(t, e) {
  ...
  if (
    ...
    d &&
      (f += d * h.lineHeight + (d - 1) * e.titleSpacing + e.titleMarginBottom),
    x)
  ) {
    f +=
  ...
  getBody(t, e) {
    ...
    return (
      each(t, (t) => {
        ...
        (pushOrConcat(
          e.before,
          splitNewlines(invokeCallbackWithFallback(a, "beforeLabel", this, t)),
        ),
          pushOrConcat(
            e.lines,
          ...
          pushOrConcat(
            e.after,
            splitNewlines(invokeCallbackWithFallback(a, "afterLabel", this, t)),
          ),
          s.push(e));
      }),
      s
    ...
    return (
      ...
      each(l, (e) => {
        ...
        (s.push(invokeCallbackWithFallback(i, "labelColor", this, e)),
          a.push(invokeCallbackWithFallback(i, "labelPointStyle", this, e)),
          n.push(invokeCallbackWithFallback(i, "labelTextColor", this, e)));
      }),
      (this.labelColors = s),
  ...
  drawBody(t, e, i) {
    ...
    for (
      e.textAlign = n,
        ...
        u = o && "right" !== f ? ("center" === n ? l / 2 + h : l + 2 + h) : 0,
        _ = 0,
        v = s.length;
      _ < v;
      ++_
...
function updateLimits(t, e, i, s, a) {
  ...
  (s.start < e.l
    ...
    : s.end > e.r && ((r = (s.end - e.r) / n), (t.r = Math.max(t.r, e.r + r))),
    a.start < e.t
...
class TimeScale extends Scale {
  ...
  determineDataLimits() {
    ...
    ((n && o) ||
      ...
      ("ticks" === t.bounds && "labels" === t.ticks.source) ||
        r(this.getMinMax(!1))),
      (s = isNumberFinite(s) && !isNaN(s) ? s : +e.startOf(Date.now(), i)),
      (a = isNumberFinite(a) && !isNaN(a) ? a : +e.endOf(Date.now(), i) + 1),
  ...
  _generate() {
    const t = this._adapter,
      ...
      n =
        a.unit ||
        determineUnitForAutoTicks(a.minUnit, e, i, this._getLabelCapacity(e)),
  ...
  _getLabelCapacity(t) {
    const e = this.options.time,
      ...
      o =
        Math.floor(this.isHorizontal() ? this.width / n.w : this.height / n.h) -
        1;
    return o > 0 ? o : 1;
  }
  getDataTimestamps() {
  ...
  buildLookupTable(t) {
    ...
    for (n = 0, o = s.length; n < o; ++n)
      ((h = s[n + 1]),
        (r = s[n - 1]),
        (l = s[n]),
        Math.round((h + r) / 2) !== l && a.push({ time: l, pos: n / (o - 1) }));
    return a;
  }
  _generate() {
    const t = this.min,
...
//# sourceMappingURL=/sm/60fe2b7b264f3f11745ac354b95faa88002416b738173fed70e6b53be952b2b7.map
